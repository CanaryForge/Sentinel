...
Toda cifra de este paper se cuenta sobre `results/` o `results/machine-B/causal-ollama0.6.8/`, con
...
python3 analysis/compute_ttd.py --results-dir results/machine-B/causal-ollama0.6.8 # causal, 30
```
